package assigment2;// Parser class for CE204 assignment 2, 2020
...
public class Parser {
    ...
    static ExpTree makeNumberLeaf(int n) {
        return ExpTree.createNode(ExpTree.TreeType.NUM_NODE, "" + n, null, null);
    ...
    static ExpTree makeIdLeaf(String s) {
        return ExpTree.createNode(ExpTree.TreeType.ID_NODE, s, null, null);
        // this method should return a new id leaf with value s
    }

    static ExpTree makePlusTree(ExpTree l, ExpTree r) {
        return ExpTree.createNode(ExpTree.TreeType.OPT_NODE, "+", l, r);
